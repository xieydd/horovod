...
check_extension('horovod.torch', 'HOROVOD_WITH_PYTORCH', __file__, 'mpi_lib', '_mpi_lib')
...
# TODO: add note in docs to use NCCL 2.1.11+ with PyTorch to avoid deadlock

# TODO: how are sparse parameters (e.g. embedding updates) handled in pytorch?
# TODO: short circuit if size() == 1?
# TODO: test that hvd.allreduce(t.cuda(async=True)) works fine
# TODO: find a way to specify DistOpt/broadcast_g_v on CPU for a GPU model

class _DistributedOptimizer(torch.optim.Optimizer):
    # TODO: make it clear that parameters are taken from optimizer,
    # TODO: and named_parameters are only used for naming
    def __init__(self, params, named_parameters=None):
        super(self.__class__, self).__init__(params)

        if named_parameters is None:
            named_parameters = []
        # TODO: weird error if you pass just parameters as named_parameters
    ...
    # TODO: required for clip_grad_norm(all_params, 5), auto-detect if missing?
...
# TODO: check whether blocking cffi operations will release GIL
...
# TODO: do we want allgather in-place option for symmetry?
...
# TODO: rename to synchronize?
def wait_and_clear(handle):
